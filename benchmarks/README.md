...
| [`feature/`](feature/) | Local-feature detector benchmarks incl. quality (matching) metrics, plus [`laf_ops.py`](feature/laf_ops.py): microbenchmarks for the shared LAF operations. |
